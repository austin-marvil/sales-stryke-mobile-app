...
class EntityAttributes {
    constructor() {
        ...
        this._ruleGroupIsMutated = "_ruleGroupIsMutated";
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.RuleBuilder";
        this.mongDataModeName = "RuleBuilder";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class RuleBuilder extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this._ruleGroupIsMutated = false;
        this.description = null;
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.RuleBuilder";
        this.name = null;
        this.ruleGroup = null;
    }
    /**
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.RuleBuilder");
    }
    /**
     ...
     * @returns boolean
     */
    _getIsRuleGroupMutated() {
        return (this._ruleGroupIsMutated);
    }
    /**
     * The description.
     * @returns string | null
    ...
    /**
     * The rule group for react query.
     * @returns RuleGroupType
     */
    getRuleGroup() {
        return EntityUtils_1.EntityUtils.jsonStringGetter({ value: this.ruleGroup || '' });
    }
    /**
     * CREATE, DELETE, UPDATE
     */
...
* ```
     */
    _setIsRuleGroupMutated(_ruleGroupIsMutated) {
        this._ruleGroupIsMutated = _ruleGroupIsMutated;
        return (this);
    }
    /**
...
* ```
    ...
    setRuleGroup(ruleGroup) {
        if (!this._getIsMutateSuppressed() && this.ruleGroup !== EntityUtils_1.EntityUtils.jsonStringSetter({ value: ruleGroup })) {
            this._setIsRuleGroupMutated(true);
        }
        this.ruleGroup = EntityUtils_1.EntityUtils.jsonStringSetter({ value: ruleGroup });
        return (this);
    }
    _getIsMutated() {
        let isMutated = false;
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.ruleGroup);
        return (hashCode_n);
    }
}
exports.RuleBuilder = RuleBuilder;
RuleBuilder.metaDataForRuleBuilder = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.RuleBuilder", RuleBuilder);
