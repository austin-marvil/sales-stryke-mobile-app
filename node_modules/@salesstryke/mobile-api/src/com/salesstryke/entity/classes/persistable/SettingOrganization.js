...
exports.SettingOrganization = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.SettingOrganization";
        this.mongDataModeName = "SettingOrganization";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class SettingOrganization extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.jsonType = "com.salesstryke.entity.classes.persistable.SettingOrganization";
        this.logo = null;
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.SettingOrganization");
    }
    /**
...
exports.SettingOrganization = SettingOrganization;
SettingOrganization.metaDataForSettingOrganization = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.SettingOrganization", SettingOrganization);
//# sourceMappingURL=SettingOrganization.js.map