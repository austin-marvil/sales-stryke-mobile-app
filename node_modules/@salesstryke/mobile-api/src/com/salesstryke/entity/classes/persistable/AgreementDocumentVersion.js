...
exports.AgreementDocumentVersion = void 0;
...
class EntityAttributes {
    constructor() {
        ...
        this._agreementTypeIsMutated = "_agreementTypeIsMutated";
        this._descriptionIsMutated = "_descriptionIsMutated";
        this._entityState = "_entityState";
        this._htmlIsMutated = "_htmlIsMutated";
        ...
        this._textIsMutated = "_textIsMutated";
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.AgreementDocumentVersion";
        this.mongDataModeName = "AgreementDocumentVersion";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class AgreementDocumentVersion extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        this._activeEndDateIsMutated = false;
        this._activeStartDateIsMutated = false;
        this._agreementDocumentIsMutated = false;
        this._agreementTypeIsMutated = false;
        this._descriptionIsMutated = false;
        this._htmlIsMutated = false;
        ...
        this.jsonType = "com.salesstryke.entity.classes.persistable.AgreementDocumentVersion";
        this.name = null;
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.AgreementDocumentVersion");
    }
    /**
     ...
     * @returns boolean
     */
    _getIsAgreementTypeMutated() {
        return (this._agreementTypeIsMutated);
    }
    /**
     *
     * @returns boolean
    ...
    /**
     * The agreement type.
     * @returns AgreementType | null
     */
    getAgreementType() {
        return (this.agreementType);
    }
    /**
     * The description of the agreement document.
     * @returns string | null
     */
    getDescription() {
    ...
    /**
     * The HTML content of the agreement document.
     * @returns string | null
     */
    getHtml() {
        return (this.html);
    ...
    /**
     * Indicates if the agreement document is active.
     * @returns boolean
     */
    getIsActive() {
    ...
    /**
     * The text of the agreement document.
     * @returns string | null
     */
    getText() {
        return (this.text);
    ...
    /**
     * The version of the agreement document.
     * @returns number
     */
    getVersion() {
        return (this.version);
...
* ```
     */
    _setIsAgreementTypeMutated(_agreementTypeIsMutated) {
        this._agreementTypeIsMutated = _agreementTypeIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    _setIsHtmlMutated(_htmlIsMutated) {
        this._htmlIsMutated = _htmlIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    _setIsTextMutated(_textIsMutated) {
        this._textIsMutated = _textIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    setAgreementType(agreementType, persistanceType) {
        if (!this._getIsMutateSuppressed() && this.agreementType !== agreementType) {
            PersistableUtils_1.PersistableUtils.mongoRefSetter(agreementType, persistanceType);
            this._setIsAgreementTypeMutated(true);
        }
        this.agreementType = agreementType;
        return (this);
    }
...
* ```
     */
    setHtml(html) {
        if (!this._getIsMutateSuppressed() && this.html !== html) {
            this._setIsHtmlMutated(true);
        }
        this.html = html;
        return (this);
    }
...
* ```
     */
    setText(text) {
        if (!this._getIsMutateSuppressed() && this.text !== text) {
            this._setIsTextMutated(true);
        }
        this.text = text;
        return (this);
    }
...
* ```
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.agreementType);
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.html);
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.text);
...
exports.AgreementDocumentVersion = AgreementDocumentVersion;
AgreementDocumentVersion.metaDataForAgreementDocumentVersion = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.AgreementDocumentVersion", AgreementDocumentVersion);
//# sourceMappingURL=AgreementDocumentVersion.js.map