...
exports.ProductColorRoute = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.ProductColorRoute";
        this.mongDataModeName = "ProductColorRoute";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class ProductColorRoute extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.ProductColorRoute";
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.ProductColorRoute");
    }
    /**
...
exports.ProductColorRoute = ProductColorRoute;
ProductColorRoute.metaDataForProductColorRoute = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.ProductColorRoute", ProductColorRoute);
//# sourceMappingURL=ProductColorRoute.js.map