...
exports.DocumentQueryDate = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.record.documentQuery.DocumentQueryDate";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class DocumentQueryDate extends JsonApiRecordBase_1.JsonApiRecordBase {
    constructor(p) {
        super(p);
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.record.documentQuery.DocumentQueryDate");
    }
    /**
     *
     * @returns boolean
...
exports.DocumentQueryDate = DocumentQueryDate;
DocumentQueryDate.metaDataForDocumentQueryDate = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.record.documentQuery.DocumentQueryDate", DocumentQueryDate);
//# sourceMappingURL=DocumentQueryDate.js.map