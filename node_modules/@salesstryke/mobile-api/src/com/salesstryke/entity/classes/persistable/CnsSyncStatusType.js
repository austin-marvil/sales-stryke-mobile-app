...
exports.CnsSyncStatusType = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.CnsSyncStatusType";
        this.mongDataModeName = "CnsSyncStatusType";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class CnsSyncStatusType extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.jsonType = "com.salesstryke.entity.classes.persistable.CnsSyncStatusType";
        this.name = null;
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.CnsSyncStatusType");
    }
    /**
    ...
    /**
     * The name description of the sync status type.
     * @returns string | null
     */
    getDescription() {
    ...
    /**
     * Indicates if the sync status type is active or not.
     * @returns boolean
     */
    getIsActive() {
...
exports.CnsSyncStatusType = CnsSyncStatusType;
CnsSyncStatusType.metaDataForCnsSyncStatusType = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.CnsSyncStatusType", CnsSyncStatusType);
//# sourceMappingURL=CnsSyncStatusType.js.map