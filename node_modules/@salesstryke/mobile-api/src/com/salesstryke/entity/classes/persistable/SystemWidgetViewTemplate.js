...
exports.SystemWidgetViewTemplate = void 0;
...
class EntityAttributes {
    constructor() {
        ...
        this._systemWidgetTemplateIsMutated = "_systemWidgetTemplateIsMutated";
        ...
        this.name = "name";
        this.systemWidgetTemplate = "systemWidgetTemplate";
    }
}
class MongoVirtual {
}
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.SystemWidgetViewTemplate";
        this.mongDataModeName = "SystemWidgetViewTemplate";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class SystemWidgetViewTemplate extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this._systemWidgetTemplateIsMutated = false;
        this.description = null;
        this.id = null;
        this.isActive = undefined;
        this.jsonType = "com.salesstryke.entity.classes.persistable.SystemWidgetViewTemplate";
        this.name = null;
        this.systemWidgetTemplate = null;
    }
    /**
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.SystemWidgetViewTemplate");
    }
    /**
     ...
     * @returns boolean
     */
    _getIsSystemWidgetTemplateMutated() {
        return (this._systemWidgetTemplateIsMutated);
    }
    /**
     * The description of the widget view.
     * @returns string | null
     */
    getDescription() {
    ...
    /**
     * Identifies if the widget view is active.
     * @returns boolean
     */
    getIsActive() {
    ...
    /**
     * The SystemWidgetTemplate this view belongs to.
     * @returns SystemWidgetTemplate | null
     */
    getSystemWidgetTemplate() {
        return (this.systemWidgetTemplate);
    }
    /**
     * CREATE, DELETE, UPDATE
     */
...
* ```
     */
    _setIsSystemWidgetTemplateMutated(_systemWidgetTemplateIsMutated) {
        this._systemWidgetTemplateIsMutated = _systemWidgetTemplateIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    setSystemWidgetTemplate(systemWidgetTemplate, persistanceType) {
        if (!this._getIsMutateSuppressed() && this.systemWidgetTemplate !== systemWidgetTemplate) {
            PersistableUtils_1.PersistableUtils.mongoRefSetter(systemWidgetTemplate, persistanceType);
            this._setIsSystemWidgetTemplateMutated(true);
        }
        this.systemWidgetTemplate = systemWidgetTemplate;
        return (this);
    }
    _getIsMutated() {
        ...
        this._setCurrentState2({
            attributeName: 'systemWidgetTemplate',
            value: this.systemWidgetTemplate
        });
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.systemWidgetTemplate);
        return (hashCode_n);
    }
}
exports.SystemWidgetViewTemplate = SystemWidgetViewTemplate;
SystemWidgetViewTemplate.metaDataForSystemWidgetViewTemplate = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.SystemWidgetViewTemplate", SystemWidgetViewTemplate);
//# sourceMappingURL=SystemWidgetViewTemplate.js.map