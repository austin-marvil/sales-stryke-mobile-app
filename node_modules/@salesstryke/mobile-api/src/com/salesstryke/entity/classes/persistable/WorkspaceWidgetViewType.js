...
exports.WorkspaceWidgetViewType = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.WorkspaceWidgetViewType";
        this.mongDataModeName = "WorkspaceWidgetViewType";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class WorkspaceWidgetViewType extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.WorkspaceWidgetViewType";
        this.name = null;
    }
    /**
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.WorkspaceWidgetViewType");
    }
    /**
    ...
    /**
     * The description for the widget view type
     * @returns string | null
     */
    getDescription() {
    ...
    /**
     * The name of the widget view type
     * @returns string | null
     */
    getName() {
        return (this.name);
...
exports.WorkspaceWidgetViewType = WorkspaceWidgetViewType;
WorkspaceWidgetViewType.metaDataForWorkspaceWidgetViewType = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.WorkspaceWidgetViewType", WorkspaceWidgetViewType);
//# sourceMappingURL=WorkspaceWidgetViewType.js.map