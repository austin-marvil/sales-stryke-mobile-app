...
exports.CnsEndPointChannelType = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.CnsEndPointChannelType";
        this.mongDataModeName = "CnsEndPointChannelType";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class CnsEndPointChannelType extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.jsonType = "com.salesstryke.entity.classes.persistable.CnsEndPointChannelType";
        this.name = null;
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.CnsEndPointChannelType");
    }
    /**
    ...
    /**
     * The name description of the channel type.
     * @returns string | null
     */
    getDescription() {
    ...
    /**
     * Indicates if the channel type is active or not.
     * @returns boolean
     */
    getIsActive() {
    ...
    /**
     * The name of the channel type: APP, EMAIL, or TEXT.
     * @returns string | null
     */
    getName() {
        return (this.name);
...
exports.CnsEndPointChannelType = CnsEndPointChannelType;
CnsEndPointChannelType.metaDataForCnsEndPointChannelType = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.CnsEndPointChannelType", CnsEndPointChannelType);
//# sourceMappingURL=CnsEndPointChannelType.js.map