...
exports.SettingNotification = void 0;
...
class EntityAttributes {
    constructor() {
        ...
        this._isClientIsMutated = "_isClientIsMutated";
        this._isCustomerIsMutated = "_isCustomerIsMutated";
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.SettingNotification";
        this.mongDataModeName = "SettingNotification";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class SettingNotification extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this._isClientIsMutated = false;
        this._isCustomerIsMutated = false;
        ...
        this.jsonType = "com.salesstryke.entity.classes.persistable.SettingNotification";
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.SettingNotification");
    }
    /**
     ...
     */
    _getIsClientMutated() {
        return (this._isClientIsMutated);
    }
    /**
     *
     * @returns boolean
     */
    _getIsCustomerMutated() {
        return (this._isCustomerIsMutated);
    }
    /**
     *
     * @returns boolean
    ...
    /**
     * notification is for client.
     * @returns boolean
     */
    getIsClient() {
        return ((this.isClient === undefined) ? false : this.isClient);
    }
    /**
     * notification is for customer.
     * @returns boolean
     */
    getIsCustomer() {
        return ((this.isCustomer === undefined) ? false : this.isCustomer);
    }
    /**
     * is Default.
     * @returns boolean
...
* ```
     */
    _setIsClientMutated(_isClientIsMutated) {
        this._isClientIsMutated = _isClientIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    _setIsCustomerMutated(_isCustomerIsMutated) {
        this._isCustomerIsMutated = _isCustomerIsMutated;
        return (this);
    }
    /**
...
* ```
    ...
    setIsClient(isClient) {
        if (!this._getIsMutateSuppressed() && this.isClient !== isClient) {
            this._setIsClientMutated(true);
        }
        this.isClient = isClient;
        return (this);
    }
...
* ```
    ...
    setIsCustomer(isCustomer) {
        if (!this._getIsMutateSuppressed() && this.isCustomer !== isCustomer) {
            this._setIsCustomerMutated(true);
        }
        this.isCustomer = isCustomer;
        return (this);
    }
...
* ```
    ...
    _getIsMutated() {
        ...
        this._setCurrentState2({
            attributeName: 'isClient',
            value: this.isClient
        });
        this._setCurrentState2({
            attributeName: 'isCustomer',
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.isClient);
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.isCustomer);
...
exports.SettingNotification = SettingNotification;
SettingNotification.metaDataForSettingNotification = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.SettingNotification", SettingNotification);
//# sourceMappingURL=SettingNotification.js.map