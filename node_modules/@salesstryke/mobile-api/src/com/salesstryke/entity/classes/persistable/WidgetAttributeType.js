...
exports.WidgetAttributeType = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.WidgetAttributeType";
        this.mongDataModeName = "WidgetAttributeType";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class WidgetAttributeType extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.jsonType = "com.salesstryke.entity.classes.persistable.WidgetAttributeType";
        this.name = null;
    }
    /**
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.WidgetAttributeType");
    }
    /**
...
exports.WidgetAttributeType = WidgetAttributeType;
WidgetAttributeType.metaDataForWidgetAttributeType = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.WidgetAttributeType", WidgetAttributeType);
//# sourceMappingURL=WidgetAttributeType.js.map