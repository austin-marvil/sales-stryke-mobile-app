...
exports.PandaDocTemplate = void 0;
...
class EntityAttributes {
    constructor() {
        ...
        this._typeScriptDataTypeIsMutated = "_typeScriptDataTypeIsMutated";
        ...
        this.typeScriptDataType = "typeScriptDataType";
    }
}
class MongoVirtual {
}
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.PandaDocTemplate";
        this.mongDataModeName = "PandaDocTemplate";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class PandaDocTemplate extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this._typeScriptDataTypeIsMutated = false;
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.PandaDocTemplate";
        this.name = null;
        this.organization = null;
        this.typeScriptDataType = null;
    }
    /**
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.PandaDocTemplate");
    }
    /**
     ...
     * @returns boolean
     */
    _getIsTypeScriptDataTypeMutated() {
        return (this._typeScriptDataTypeIsMutated);
    }
    /**
     *
     * @returns string | null
     ...
     * @returns string | null
     */
    getTypeScriptDataType() {
        return (this.typeScriptDataType);
    }
    /**
     * CREATE, DELETE, UPDATE
     */
...
* ```
     */
    _setIsTypeScriptDataTypeMutated(_typeScriptDataTypeIsMutated) {
        this._typeScriptDataTypeIsMutated = _typeScriptDataTypeIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    setTypeScriptDataType(typeScriptDataType) {
        if (!this._getIsMutateSuppressed() && this.typeScriptDataType !== typeScriptDataType) {
            this._setIsTypeScriptDataTypeMutated(true);
        }
        this.typeScriptDataType = typeScriptDataType;
        return (this);
    }
    _getIsMutated() {
        ...
        this._setCurrentState2({
            attributeName: 'typeScriptDataType',
            value: this.typeScriptDataType
        });
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.typeScriptDataType);
        return (hashCode_n);
    }
}
exports.PandaDocTemplate = PandaDocTemplate;
PandaDocTemplate.metaDataForPandaDocTemplate = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.PandaDocTemplate", PandaDocTemplate);
//# sourceMappingURL=PandaDocTemplate.js.map