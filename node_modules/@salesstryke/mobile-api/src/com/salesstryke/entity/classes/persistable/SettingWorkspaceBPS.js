...
exports.SettingWorkspaceBPS = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.SettingWorkspaceBPS";
        this.mongDataModeName = "SettingWorkspaceBPS";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class SettingWorkspaceBPS extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.jsonType = "com.salesstryke.entity.classes.persistable.SettingWorkspaceBPS";
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.SettingWorkspaceBPS");
    }
    /**
...
exports.SettingWorkspaceBPS = SettingWorkspaceBPS;
SettingWorkspaceBPS.metaDataForSettingWorkspaceBPS = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.SettingWorkspaceBPS", SettingWorkspaceBPS);
//# sourceMappingURL=SettingWorkspaceBPS.js.map