...
exports.ProductServiceDayOfWeekKmlLocation = void 0;
...
class EntityAttributes {
    constructor() {
        ...
        this._productServiceDayOfWeekIsMutated = "_productServiceDayOfWeekIsMutated";
        ...
        this.productServiceDayOfWeek = "productServiceDayOfWeek";
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.ProductServiceDayOfWeekKmlLocation";
        this.mongDataModeName = "ProductServiceDayOfWeekKmlLocation";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class ProductServiceDayOfWeekKmlLocation extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this._productServiceDayOfWeekIsMutated = false;
        this._workspaceIsMutated = false;
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.ProductServiceDayOfWeekKmlLocation";
        this.kml = null;
        this.kmlLayer = null;
        this.organization = null;
        this.productServiceDayOfWeek = null;
        this.workspace = null;
    }
    /**
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.ProductServiceDayOfWeekKmlLocation");
    }
    /**
     ...
     * @returns boolean
     */
    _getIsProductServiceDayOfWeekMutated() {
        return (this._productServiceDayOfWeekIsMutated);
    }
    /**
     *
     * @returns boolean
    ...
    /**
     * Product Service Day of Week mongo ref.
     * @returns ProductServiceDayOfWeek | null
     */
    getProductServiceDayOfWeek() {
        return (this.productServiceDayOfWeek);
    }
    /**
...
* ```
     */
    _setIsProductServiceDayOfWeekMutated(_productServiceDayOfWeekIsMutated) {
        this._productServiceDayOfWeekIsMutated = _productServiceDayOfWeekIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    setProductServiceDayOfWeek(productServiceDayOfWeek, persistanceType) {
        if (!this._getIsMutateSuppressed() && this.productServiceDayOfWeek !== productServiceDayOfWeek) {
            PersistableUtils_1.PersistableUtils.mongoRefSetter(productServiceDayOfWeek, persistanceType);
            this._setIsProductServiceDayOfWeekMutated(true);
        }
        this.productServiceDayOfWeek = productServiceDayOfWeek;
        return (this);
    }
...
* ```
    ...
    _getIsMutated() {
        ...
        this._setCurrentState2({
            attributeName: 'productServiceDayOfWeek',
            value: this.productServiceDayOfWeek
        });
        this._setCurrentState2({
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.productServiceDayOfWeek);
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.workspace);
        return (hashCode_n);
    }
}
exports.ProductServiceDayOfWeekKmlLocation = ProductServiceDayOfWeekKmlLocation;
ProductServiceDayOfWeekKmlLocation.metaDataForProductServiceDayOfWeekKmlLocation = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.ProductServiceDayOfWeekKmlLocation", ProductServiceDayOfWeekKmlLocation);
//# sourceMappingURL=ProductServiceDayOfWeekKmlLocation.js.map