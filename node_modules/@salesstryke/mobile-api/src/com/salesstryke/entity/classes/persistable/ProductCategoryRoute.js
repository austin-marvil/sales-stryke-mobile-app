...
class EntityAttributes {
    constructor() {
        ...
        this._routeIsMutated = "_routeIsMutated";
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.ProductCategoryRoute";
        this.mongDataModeName = "ProductCategoryRoute";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class ProductCategoryRoute extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this._routeIsMutated = false;
        this._workspaceIsMutated = false;
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.ProductCategoryRoute";
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.ProductCategoryRoute");
    }
    /**
...
* ```
     */
    _setIsRouteMutated(_routeIsMutated) {
        this._routeIsMutated = _routeIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    setRoute(route, persistanceType) {
        if (!this._getIsMutateSuppressed() && this.route !== route) {
            PersistableUtils_1.PersistableUtils.mongoRefSetter(route, persistanceType);
            this._setIsRouteMutated(true);
        }
        this.route = route;
        return (this);
    }
...
* ```
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.route);
...
ProductCategoryRoute.metaDataForProductCategoryRoute = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.ProductCategoryRoute", ProductCategoryRoute);
//# sourceMappingURL=ProductCategoryRoute.js.map