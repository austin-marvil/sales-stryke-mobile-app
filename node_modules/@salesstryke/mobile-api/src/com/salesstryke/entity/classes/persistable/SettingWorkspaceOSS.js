...
exports.SettingWorkspaceOSS = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.SettingWorkspaceOSS";
        this.mongDataModeName = "SettingWorkspaceOSS";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class SettingWorkspaceOSS extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.jsonType = "com.salesstryke.entity.classes.persistable.SettingWorkspaceOSS";
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.SettingWorkspaceOSS");
    }
    /**
...
exports.SettingWorkspaceOSS = SettingWorkspaceOSS;
SettingWorkspaceOSS.metaDataForSettingWorkspaceOSS = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.SettingWorkspaceOSS", SettingWorkspaceOSS);
//# sourceMappingURL=SettingWorkspaceOSS.js.map