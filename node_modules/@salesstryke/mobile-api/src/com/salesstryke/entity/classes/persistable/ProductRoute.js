...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.ProductRoute";
        this.mongDataModeName = "ProductRoute";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class ProductRoute extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.ProductRoute";
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.ProductRoute");
    }
    /**
...
ProductRoute.metaDataForProductRoute = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.ProductRoute", ProductRoute);
