...
exports.ProductCategoryImageKmlLocation = void 0;
...
class EntityAttributes {
    constructor() {
        ...
        this._productCategoryImageIsMutated = "_productCategoryImageIsMutated";
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.ProductCategoryImageKmlLocation";
        this.mongDataModeName = "ProductCategoryImageKmlLocation";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class ProductCategoryImageKmlLocation extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this._productCategoryImageIsMutated = false;
        this._workspaceIsMutated = false;
        this.description = null;
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.ProductCategoryImageKmlLocation";
        this.kml = null;
        this.kmlGeometry = null;
        this.kmlLayer = null;
        this.name = null;
        this.organization = null;
        this.productCategoryImage = null;
        this.workspace = null;
    }
    /**
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.ProductCategoryImageKmlLocation");
    }
    /**
     ...
     * @returns boolean
     */
    _getIsProductCategoryImageMutated() {
        return (this._productCategoryImageIsMutated);
    }
    /**
     *
     * @returns boolean
...
* ```
     */
    _setIsProductCategoryImageMutated(_productCategoryImageIsMutated) {
        this._productCategoryImageIsMutated = _productCategoryImageIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    setProductCategoryImage(productCategoryImage, persistanceType) {
        if (!this._getIsMutateSuppressed() && this.productCategoryImage !== productCategoryImage) {
            PersistableUtils_1.PersistableUtils.mongoRefSetter(productCategoryImage, persistanceType);
            this._setIsProductCategoryImageMutated(true);
        }
        this.productCategoryImage = productCategoryImage;
        return (this);
    }
...
* ```
    ...
    _getIsMutated() {
        ...
        this._setCurrentState2({
            attributeName: 'productCategoryImage',
            value: this.productCategoryImage
        });
        this._setCurrentState2({
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.productCategoryImage);
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.workspace);
        return (hashCode_n);
    }
}
exports.ProductCategoryImageKmlLocation = ProductCategoryImageKmlLocation;
ProductCategoryImageKmlLocation.metaDataForProductCategoryImageKmlLocation = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.ProductCategoryImageKmlLocation", ProductCategoryImageKmlLocation);
//# sourceMappingURL=ProductCategoryImageKmlLocation.js.map