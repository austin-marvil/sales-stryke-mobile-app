...
exports.SoftPakSizeAndChargeCode = void 0;
...
class EntityAttributes {
    constructor() {
        ...
        this._serviceTypeIsMutated = "_serviceTypeIsMutated";
        this._sizeIsMutated = "_sizeIsMutated";
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.SoftPakSizeAndChargeCode";
        this.mongDataModeName = "SoftPakSizeAndChargeCode";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class SoftPakSizeAndChargeCode extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this._serviceTypeIsMutated = false;
        this._sizeIsMutated = false;
        this.description = null;
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.SoftPakSizeAndChargeCode";
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.SoftPakSizeAndChargeCode");
    }
    /**
     ...
     * @returns boolean
     */
    _getIsServiceTypeMutated() {
        return (this._serviceTypeIsMutated);
    }
    /**
     *
     * @returns boolean
     */
    _getIsSizeMutated() {
        return (this._sizeIsMutated);
    }
    /**
     * The charge code description.
     * @returns string | null
     */
    getDescription() {
    ...
    /**
     * The service type. Typically something like RS for Recycle Service, TS for Trash Service, etc.
     * @returns string | null
     */
    getServiceType() {
    ...
    /**
     * The service size. 40 can indicate 40yrd dumpster, 96 can indicate 96 gallon cart.
     * @returns number
     */
    getSize() {
        return (this.size);
...
* ```
     */
    _setIsServiceTypeMutated(_serviceTypeIsMutated) {
        this._serviceTypeIsMutated = _serviceTypeIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    _setIsSizeMutated(_sizeIsMutated) {
        this._sizeIsMutated = _sizeIsMutated;
        return (this);
    }
    /**
...
* ```
    ...
    setServiceType(serviceType) {
        if (!this._getIsMutateSuppressed() && this.serviceType !== serviceType) {
            this._setIsServiceTypeMutated(true);
        }
        this.serviceType = serviceType;
        return (this);
    }
...
* ```
     */
    setSize(size) {
        if (!this._getIsMutateSuppressed() && this.size !== size) {
            this._setIsSizeMutated(true);
        }
        this.size = size;
        return (this);
    }
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.serviceType);
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.size);
        return (hashCode_n);
    }
}
exports.SoftPakSizeAndChargeCode = SoftPakSizeAndChargeCode;
SoftPakSizeAndChargeCode.metaDataForSoftPakSizeAndChargeCode = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.SoftPakSizeAndChargeCode", SoftPakSizeAndChargeCode);
//# sourceMappingURL=SoftPakSizeAndChargeCode.js.map