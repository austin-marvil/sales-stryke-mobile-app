...
exports.ServiceGeoKmlLocation = void 0;
...
class EntityAttributes {
    constructor() {
        ...
        this._serviceGeoIsMutated = "_serviceGeoIsMutated";
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.ServiceGeoKmlLocation";
        this.mongDataModeName = "ServiceGeoKmlLocation";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class ServiceGeoKmlLocation extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this._serviceGeoIsMutated = false;
        this._workspaceIsMutated = false;
        this.description = null;
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.ServiceGeoKmlLocation";
        this.kml = null;
        this.kmlGeometry = null;
        this.kmlLayer = null;
        this.name = null;
        this.serviceGeo = null;
        this.workspace = null;
    }
    /**
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.ServiceGeoKmlLocation");
    }
    /**
     ...
     * @returns boolean
     */
    _getIsServiceGeoMutated() {
        return (this._serviceGeoIsMutated);
    }
    /**
     *
     * @returns boolean
    ...
    /**
     * The service geo.
     * @returns ServiceGeo | null
     */
    getServiceGeo() {
        return (this.serviceGeo);
    }
    /**
...
* ```
     */
    _setIsServiceGeoMutated(_serviceGeoIsMutated) {
        this._serviceGeoIsMutated = _serviceGeoIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    setServiceGeo(serviceGeo, persistanceType) {
        if (!this._getIsMutateSuppressed() && this.serviceGeo !== serviceGeo) {
            PersistableUtils_1.PersistableUtils.mongoRefSetter(serviceGeo, persistanceType);
            this._setIsServiceGeoMutated(true);
        }
        this.serviceGeo = serviceGeo;
        return (this);
    }
...
* ```
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.serviceGeo);
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.workspace);
        return (hashCode_n);
    }
}
exports.ServiceGeoKmlLocation = ServiceGeoKmlLocation;
ServiceGeoKmlLocation.metaDataForServiceGeoKmlLocation = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.ServiceGeoKmlLocation", ServiceGeoKmlLocation);
//# sourceMappingURL=ServiceGeoKmlLocation.js.map