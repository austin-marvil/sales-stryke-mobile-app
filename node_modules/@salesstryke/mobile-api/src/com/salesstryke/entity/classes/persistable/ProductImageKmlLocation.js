...
exports.ProductImageKmlLocation = void 0;
...
class EntityAttributes {
    constructor() {
        ...
        this._productImageIsMutated = "_productImageIsMutated";
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.ProductImageKmlLocation";
        this.mongDataModeName = "ProductImageKmlLocation";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class ProductImageKmlLocation extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this._productImageIsMutated = false;
        this._workspaceIsMutated = false;
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.ProductImageKmlLocation";
        this.kml = null;
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.ProductImageKmlLocation");
    }
    /**
     ...
     * @returns boolean
     */
    _getIsProductImageMutated() {
        return (this._productImageIsMutated);
    }
    /**
     *
     * @returns boolean
...
* ```
     */
    _setIsProductImageMutated(_productImageIsMutated) {
        this._productImageIsMutated = _productImageIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    setProductImage(productImage, persistanceType) {
        if (!this._getIsMutateSuppressed() && this.productImage !== productImage) {
            PersistableUtils_1.PersistableUtils.mongoRefSetter(productImage, persistanceType);
            this._setIsProductImageMutated(true);
        }
        this.productImage = productImage;
        return (this);
    }
...
* ```
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.productImage);
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.workspace);
        return (hashCode_n);
    }
}
exports.ProductImageKmlLocation = ProductImageKmlLocation;
ProductImageKmlLocation.metaDataForProductImageKmlLocation = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.ProductImageKmlLocation", ProductImageKmlLocation);
//# sourceMappingURL=ProductImageKmlLocation.js.map