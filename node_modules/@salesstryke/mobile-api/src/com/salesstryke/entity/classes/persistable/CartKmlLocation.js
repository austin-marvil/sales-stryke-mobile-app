...
exports.CartKmlLocation = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.CartKmlLocation";
        this.mongDataModeName = "CartKmlLocation";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class CartKmlLocation extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.CartKmlLocation";
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.CartKmlLocation");
    }
    /**
...
exports.CartKmlLocation = CartKmlLocation;
CartKmlLocation.metaDataForCartKmlLocation = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.CartKmlLocation", CartKmlLocation);
//# sourceMappingURL=CartKmlLocation.js.map