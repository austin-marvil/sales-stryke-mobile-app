...
exports.ProductCategoryRule = void 0;
...
class EntityAttributes {
    constructor() {
        ...
        this._multiplierIsMutated = "_multiplierIsMutated";
        ...
        this._rulesIsMutated = "_rulesIsMutated";
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.ProductCategoryRule";
        this.mongDataModeName = "ProductCategoryRule";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class ProductCategoryRule extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.ProductCategoryRule");
    }
    /**
     ...
     * @returns boolean
     */
    _getIsMultiplierMutated() {
        return (this._multiplierIsMutated);
    }
    /**
     *
     * @returns boolean
...
* ```
     */
    _setIsMultiplierMutated(_multiplierIsMutated) {
        this._multiplierIsMutated = _multiplierIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    _setIsRulesMutated(_rulesIsMutated) {
        this._rulesIsMutated = _rulesIsMutated;
        return (this);
    }
    /**
...
* ```
    ...
    setMultiplier(multiplier) {
        if (!this._getIsMutateSuppressed() && this.multiplier !== multiplier) {
            this._setIsMultiplierMutated(true);
        }
        this.multiplier = multiplier;
        return (this);
    }
...
* ```
     */
    setRules(rules) {
        if (!this._getIsMutateSuppressed() && this.rules !== rules) {
            this._setIsRulesMutated(true);
        }
        this.rules = rules;
        return (this);
    }
...
* ```
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.multiplier);
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.rules);
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.workspace);
        return (hashCode_n);
    }
}
exports.ProductCategoryRule = ProductCategoryRule;
ProductCategoryRule.metaDataForProductCategoryRule = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.ProductCategoryRule", ProductCategoryRule);
//# sourceMappingURL=ProductCategoryRule.js.map