...
exports.ProductPricingRule = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.ProductPricingRule";
        this.mongDataModeName = "ProductPricingRule";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class ProductPricingRule extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.ProductPricingRule";
        this.name = null;
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.ProductPricingRule");
    }
    /**
...
exports.ProductPricingRule = ProductPricingRule;
ProductPricingRule.metaDataForProductPricingRule = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.ProductPricingRule", ProductPricingRule);
//# sourceMappingURL=ProductPricingRule.js.map