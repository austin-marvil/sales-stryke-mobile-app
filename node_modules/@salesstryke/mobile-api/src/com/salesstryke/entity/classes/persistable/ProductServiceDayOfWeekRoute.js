...
exports.ProductServiceDayOfWeekRoute = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.ProductServiceDayOfWeekRoute";
        this.mongDataModeName = "ProductServiceDayOfWeekRoute";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class ProductServiceDayOfWeekRoute extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.ProductServiceDayOfWeekRoute";
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.ProductServiceDayOfWeekRoute");
    }
    /**
...
exports.ProductServiceDayOfWeekRoute = ProductServiceDayOfWeekRoute;
ProductServiceDayOfWeekRoute.metaDataForProductServiceDayOfWeekRoute = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.ProductServiceDayOfWeekRoute", ProductServiceDayOfWeekRoute);
//# sourceMappingURL=ProductServiceDayOfWeekRoute.js.map