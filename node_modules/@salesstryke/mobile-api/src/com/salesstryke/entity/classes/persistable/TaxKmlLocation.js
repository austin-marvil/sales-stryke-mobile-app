...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.TaxKmlLocation";
        this.mongDataModeName = "TaxKmlLocation";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class TaxKmlLocation extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.TaxKmlLocation";
        this.kml = null;
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.TaxKmlLocation");
    }
    /**
...
exports.TaxKmlLocation = TaxKmlLocation;
TaxKmlLocation.metaDataForTaxKmlLocation = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.TaxKmlLocation", TaxKmlLocation);
//# sourceMappingURL=TaxKmlLocation.js.map