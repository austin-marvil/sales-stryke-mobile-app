...
exports.ProductStartServiceMinimumDaysFromPurchase = void 0;
...
class EntityAttributes {
    constructor() {
        ...
        this._minDaysFromPurcaseIsMutated = "_minDaysFromPurcaseIsMutated";
        ...
        this.minDaysFromPurcase = "minDaysFromPurcase";
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.ProductStartServiceMinimumDaysFromPurchase";
        this.mongDataModeName = "ProductStartServiceMinimumDaysFromPurchase";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class ProductStartServiceMinimumDaysFromPurchase extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this._minDaysFromPurcaseIsMutated = false;
        ...
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.ProductStartServiceMinimumDaysFromPurchase";
        this.minDaysFromPurcase = 0;
        this.name = null;
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.ProductStartServiceMinimumDaysFromPurchase");
    }
    /**
     ...
     * @returns boolean
     */
    _getIsMinDaysFromPurcaseMutated() {
        return (this._minDaysFromPurcaseIsMutated);
    }
    /**
     *
     * @returns boolean
    ...
    /**
     * The minimun days from purchase.
     * @returns number
     */
    getMinDaysFromPurcase() {
        return (this.minDaysFromPurcase);
    }
    /**
     * The name.
     * @returns string | null
...
* ```
     */
    _setIsMinDaysFromPurcaseMutated(_minDaysFromPurcaseIsMutated) {
        this._minDaysFromPurcaseIsMutated = _minDaysFromPurcaseIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    setMinDaysFromPurcase(minDaysFromPurcase) {
        if (!this._getIsMutateSuppressed() && this.minDaysFromPurcase !== minDaysFromPurcase) {
            this._setIsMinDaysFromPurcaseMutated(true);
        }
        this.minDaysFromPurcase = minDaysFromPurcase;
        return (this);
    }
...
* ```
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.minDaysFromPurcase);
...
exports.ProductStartServiceMinimumDaysFromPurchase = ProductStartServiceMinimumDaysFromPurchase;
ProductStartServiceMinimumDaysFromPurchase.metaDataForProductStartServiceMinimumDaysFromPurchase = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.ProductStartServiceMinimumDaysFromPurchase", ProductStartServiceMinimumDaysFromPurchase);
//# sourceMappingURL=ProductStartServiceMinimumDaysFromPurchase.js.map