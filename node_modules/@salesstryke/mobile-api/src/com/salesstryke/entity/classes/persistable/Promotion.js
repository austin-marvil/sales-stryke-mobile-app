...
class EntityAttributes {
    constructor() {
        ...
        this._amountOffIsMutated = "_amountOffIsMutated";
        ...
        this._percentageOffIsMutated = "_percentageOffIsMutated";
        this._productIsMutated = "_productIsMutated";
        this._promoCodeIsMutated = "_promoCodeIsMutated";
        this._promoPriceIsMutated = "_promoPriceIsMutated";
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.Promotion";
        this.mongDataModeName = "Promotion";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class Promotion extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        this._activeEndDateIsMutated = false;
        this._activeStartDateIsMutated = false;
        this._amountOffIsMutated = false;
        ...
        this._percentageOffIsMutated = false;
        this._productIsMutated = false;
        this._promoCodeIsMutated = false;
        this._promoPriceIsMutated = false;
        ...
        this.jsonType = "com.salesstryke.entity.classes.persistable.Promotion";
        this.name = null;
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.Promotion");
    }
    /**
     ...
     * @returns boolean
     */
    _getIsAmountOffMutated() {
        return (this._amountOffIsMutated);
    }
    /**
     *
     * @returns boolean
     ...
     * @returns boolean
     */
    _getIsPercentageOffMutated() {
        return (this._percentageOffIsMutated);
    }
    /**
     *
     * @returns boolean
     ...
     * @returns boolean
     */
    _getIsPromoCodeMutated() {
        return (this._promoCodeIsMutated);
    }
    /**
     *
     * @returns boolean
     */
    _getIsPromoPriceMutated() {
        return (this._promoPriceIsMutated);
    }
    /**
     * Active end date.
     * @returns Date | null
    ...
    /**
     * Identifies if the promotion is active.
     * @returns boolean
     */
    getIsActive() {
...
* ```
     */
    _setIsAmountOffMutated(_amountOffIsMutated) {
        this._amountOffIsMutated = _amountOffIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    _setIsPercentageOffMutated(_percentageOffIsMutated) {
        this._percentageOffIsMutated = _percentageOffIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    _setIsPromoCodeMutated(_promoCodeIsMutated) {
        this._promoCodeIsMutated = _promoCodeIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    _setIsPromoPriceMutated(_promoPriceIsMutated) {
        this._promoPriceIsMutated = _promoPriceIsMutated;
        return (this);
    }
    /**
...
* ```
    ...
    setAmountOff(amountOff) {
        if (!this._getIsMutateSuppressed() && this.amountOff !== amountOff) {
            this._setIsAmountOffMutated(true);
        }
        this.amountOff = amountOff;
        return (this);
    }
...
* ```
    ...
    setPercentageOff(percentageOff) {
        if (!this._getIsMutateSuppressed() && this.percentageOff !== percentageOff) {
            this._setIsPercentageOffMutated(true);
        }
        this.percentageOff = percentageOff;
        return (this);
    }
...
* ```
    ...
    setPromoCode(promoCode) {
        if (!this._getIsMutateSuppressed() && this.promoCode !== promoCode) {
            this._setIsPromoCodeMutated(true);
        }
        this.promoCode = promoCode;
        return (this);
    }
...
* ```
    ...
    setPromoPrice(promoPrice) {
        if (!this._getIsMutateSuppressed() && this.promoPrice !== promoPrice) {
            this._setIsPromoPriceMutated(true);
        }
        this.promoPrice = promoPrice;
        return (this);
    }
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.amountOff);
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.percentageOff);
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.product);
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.promoCode);
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.promoPrice);
        return (hashCode_n);
    }
}
exports.Promotion = Promotion;
Promotion.metaDataForPromotion = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.Promotion", Promotion);
