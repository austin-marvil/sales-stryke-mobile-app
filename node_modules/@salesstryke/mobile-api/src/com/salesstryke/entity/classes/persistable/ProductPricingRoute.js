...
exports.ProductPricingRoute = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.ProductPricingRoute";
        this.mongDataModeName = "ProductPricingRoute";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class ProductPricingRoute extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.ProductPricingRoute";
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.ProductPricingRoute");
    }
    /**
...
exports.ProductPricingRoute = ProductPricingRoute;
ProductPricingRoute.metaDataForProductPricingRoute = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.ProductPricingRoute", ProductPricingRoute);
//# sourceMappingURL=ProductPricingRoute.js.map