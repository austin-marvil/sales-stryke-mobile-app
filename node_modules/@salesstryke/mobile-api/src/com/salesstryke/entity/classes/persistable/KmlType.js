...
class EntityAttributes {
    constructor() {
        ...
        this._zIndexIsMutated = "_zIndexIsMutated";
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.KmlType";
        this.mongDataModeName = "KmlType";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class KmlType extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this._zIndexIsMutated = false;
        this.description = null;
        this.id = null;
        this.isCustomerForOrganization = undefined;
        this.jsonType = "com.salesstryke.entity.classes.persistable.KmlType";
        this.name = null;
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.KmlType");
    }
    /**
    ...
    /**
     * Is the customer for an organization.
     * @returns boolean
     */
...
* ```
     */
    _setIsZIndexMutated(_zIndexIsMutated) {
        this._zIndexIsMutated = _zIndexIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    setZIndex(zIndex) {
        if (!this._getIsMutateSuppressed() && this.zIndex !== zIndex) {
            this._setIsZIndexMutated(true);
        }
        this.zIndex = zIndex;
        return (this);
    }
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.zIndex);
        return (hashCode_n);
    }
}
exports.KmlType = KmlType;
KmlType.metaDataForKmlType = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.KmlType", KmlType);
//# sourceMappingURL=KmlType.js.map