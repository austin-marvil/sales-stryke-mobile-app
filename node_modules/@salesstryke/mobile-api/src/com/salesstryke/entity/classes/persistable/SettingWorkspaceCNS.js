...
exports.SettingWorkspaceCNS = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.SettingWorkspaceCNS";
        this.mongDataModeName = "SettingWorkspaceCNS";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class SettingWorkspaceCNS extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.jsonType = "com.salesstryke.entity.classes.persistable.SettingWorkspaceCNS";
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.SettingWorkspaceCNS");
    }
    /**
...
exports.SettingWorkspaceCNS = SettingWorkspaceCNS;
SettingWorkspaceCNS.metaDataForSettingWorkspaceCNS = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.SettingWorkspaceCNS", SettingWorkspaceCNS);
//# sourceMappingURL=SettingWorkspaceCNS.js.map