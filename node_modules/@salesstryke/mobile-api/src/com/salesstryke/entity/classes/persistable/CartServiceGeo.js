...
class EntityAttributes {
    constructor() {
        ...
        this._longIsMutated = "_longIsMutated";
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.CartServiceGeo";
        this.mongDataModeName = "CartServiceGeo";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class CartServiceGeo extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this._longIsMutated = false;
        this._nameIsMutated = false;
        this._organizationIsMutated = false;
        this.cartItem = null;
        this.description = null;
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.CartServiceGeo";
        this.lat = 0;
        this.long = 0;
        this.name = null;
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.CartServiceGeo");
    }
    /**
...
* ```
     */
    _setIsLongMutated(_longIsMutated) {
        this._longIsMutated = _longIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    setLong(long) {
        if (!this._getIsMutateSuppressed() && this.long !== long) {
            this._setIsLongMutated(true);
        }
        this.long = long;
        return (this);
    }
...
* ```
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.long);
...
exports.CartServiceGeo = CartServiceGeo;
CartServiceGeo.metaDataForCartServiceGeo = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.CartServiceGeo", CartServiceGeo);
//# sourceMappingURL=CartServiceGeo.js.map