...
class EntityAttributes {
    constructor() {
        ...
        this._productColorTypeIsMutated = "_productColorTypeIsMutated";
        ...
        this.productColorType = "productColorType";
    }
}
class MongoVirtual {
}
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.ProductColor";
        this.mongDataModeName = "ProductColor";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class ProductColor extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this._productColorTypeIsMutated = false;
        ...
        this.jsonType = "com.salesstryke.entity.classes.persistable.ProductColor";
        this.name = null;
        this.organization = null;
        this.product = null;
        this.productColorType = null;
    }
    /**
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.ProductColor");
    }
    /**
     ...
     * @returns boolean
     */
    _getIsProductColorTypeMutated() {
        return (this._productColorTypeIsMutated);
    }
    /**
     *
     * @returns boolean
    ...
    /**
     * The description for this product color.
     * @returns string | null
     */
    getDescription() {
    ...
    /**
     * Identifies if the product color is active.
     * @returns boolean
     */
    getIsActive() {
    ...
    /**
     * The name for this product color.
     * @returns string | null
     */
    getName() {
        return (this.name);
    ...
    /**
     * The product color type.
     * @returns ProductColorType | null
     */
    getProductColorType() {
        return (this.productColorType);
    }
    /**
     * CREATE, DELETE, UPDATE
     */
...
* ```
     */
    _setIsProductColorTypeMutated(_productColorTypeIsMutated) {
        this._productColorTypeIsMutated = _productColorTypeIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    setProductColorType(productColorType, persistanceType) {
        if (!this._getIsMutateSuppressed() && this.productColorType !== productColorType) {
            PersistableUtils_1.PersistableUtils.mongoRefSetter(productColorType, persistanceType);
            this._setIsProductColorTypeMutated(true);
        }
        this.productColorType = productColorType;
        return (this);
    }
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.productColorType);
        return (hashCode_n);
    }
}
exports.ProductColor = ProductColor;
ProductColor.metaDataForProductColor = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.ProductColor", ProductColor);
//# sourceMappingURL=ProductColor.js.map