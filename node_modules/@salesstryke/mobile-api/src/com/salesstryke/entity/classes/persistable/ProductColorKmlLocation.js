...
exports.ProductColorKmlLocation = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.ProductColorKmlLocation";
        this.mongDataModeName = "ProductColorKmlLocation";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class ProductColorKmlLocation extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.ProductColorKmlLocation";
        this.kml = null;
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.ProductColorKmlLocation");
    }
    /**
...
exports.ProductColorKmlLocation = ProductColorKmlLocation;
ProductColorKmlLocation.metaDataForProductColorKmlLocation = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.ProductColorKmlLocation", ProductColorKmlLocation);
//# sourceMappingURL=ProductColorKmlLocation.js.map