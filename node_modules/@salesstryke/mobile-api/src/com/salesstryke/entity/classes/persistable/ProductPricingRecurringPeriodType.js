...
exports.ProductPricingRecurringPeriodType = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.ProductPricingRecurringPeriodType";
        this.mongDataModeName = "ProductPricingRecurringPeriodType";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class ProductPricingRecurringPeriodType extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.jsonType = "com.salesstryke.entity.classes.persistable.ProductPricingRecurringPeriodType";
        this.name = null;
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.ProductPricingRecurringPeriodType");
    }
    /**
    ...
    /**
     * The name of product pricing recurring period type.
     * @returns string | null
     */
    getName() {
        return (this.name);
...
* ```
    ...
    _getIsMutated() {
        ...
        this._setCurrentState2({
            ...
            value: this.isCustomerForOrganization
        });
        this._setCurrentState2({
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.isCustomerForOrganization);
...
exports.ProductPricingRecurringPeriodType = ProductPricingRecurringPeriodType;
ProductPricingRecurringPeriodType.metaDataForProductPricingRecurringPeriodType = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.ProductPricingRecurringPeriodType", ProductPricingRecurringPeriodType);
//# sourceMappingURL=ProductPricingRecurringPeriodType.js.map