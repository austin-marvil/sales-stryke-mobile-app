...
exports.SettingWorkspaceSES = void 0;
...
class EntityAttributes {
    constructor() {
        this._aStringIsMutated = "_aStringIsMutated";
        ...
        this._isKmlIsMutated = "_isKmlIsMutated";
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.SettingWorkspaceSES";
        this.mongDataModeName = "SettingWorkspaceSES";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class SettingWorkspaceSES extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        this._aStringIsMutated = false;
        ...
        this.isKml = undefined;
        this.jsonType = "com.salesstryke.entity.classes.persistable.SettingWorkspaceSES";
        this.organization = null;
        this.settingIntegrations = new Array();
        this.workspace = null;
    }
    /**
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.SettingWorkspaceSES");
    }
    /**
     ...
     */
    addSettingIntegration(settingIntegration, persistanceType = PersistenceType_1.PersistenceType.ATTACH) {
        if (this._getIsTrackingMutations()) {
            settingIntegration._trackMutations();
        }
        settingIntegration._setRelationshipPersistableType(persistanceType.getId());
        this.settingIntegrations.push(settingIntegration);
        return (this);
    }
    /**
     * The settingIntegration.
     ...
     */
    removeSettingIntegration(settingIntegration, persistanceType = PersistenceType_1.PersistenceType.DETACH) {
        if (this._getIsTrackingMutations()) {
            settingIntegration._trackMutations();
        }
        if (persistanceType === PersistenceType_1.PersistenceType.NONE) {
            let index = this.settingIntegrations.findIndex(obj => obj === settingIntegration);
            if (index !== -1) {
                this.settingIntegrations.splice(index, 1);
            }
            settingIntegration._setRelationshipPersistableType(PersistenceType_1.PersistenceType.NONE.getId());
            return (this);
        }
        settingIntegration._setRelationshipPersistableType(persistanceType.getId());
        this.settingIntegrations.push(settingIntegration);
     ...
     * @returns boolean
     */
    _getIsAStringMutated() {
        return (this._aStringIsMutated);
    }
    /**
     ...
     */
    getIsKml() {
        return ((this.isKml === undefined) ? false : this.isKml);
    }
    /**
     *
     * @returns string | null
    ...
    getSettingIntegrations() {
        return (this.settingIntegrations);
    }
    /**
     * The workspace.
...
* ```
     */
    _setIsAStringMutated(_aStringIsMutated) {
        this._aStringIsMutated = _aStringIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    _setIsKmlMutated(_isKmlIsMutated) {
        this._isKmlIsMutated = _isKmlIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    setAString(aString) {
        if (!this._getIsMutateSuppressed() && this.aString !== aString) {
            this._setIsAStringMutated(true);
        }
        this.aString = aString;
        return (this);
    }
...
* ```
     */
    setIsKml(isKml) {
        if (!this._getIsMutateSuppressed() && this.isKml !== isKml) {
...
* ```
    ...
    setSettingIntegrations(settingIntegrations) {
        if (!this._getIsMutateSuppressed() && this.settingIntegrations !== settingIntegrations) {
...
* ```
    ...
    getHashCode() {
        let hashCode_n = -1;
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.aString);
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.isKml);
...
exports.SettingWorkspaceSES = SettingWorkspaceSES;
SettingWorkspaceSES.metaDataForSettingWorkspaceSES = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.SettingWorkspaceSES", SettingWorkspaceSES);
//# sourceMappingURL=SettingWorkspaceSES.js.map