...
exports.ProductCategoryProduct = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.ProductCategoryProduct";
        this.mongDataModeName = "ProductCategoryProduct";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class ProductCategoryProduct extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.jsonType = "com.salesstryke.entity.classes.persistable.ProductCategoryProduct";
        this.name = null;
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.ProductCategoryProduct");
    }
    /**
    ...
    /**
     * Identifies if the product category product is active.
     * @returns boolean
     */
    getIsActive() {
...
exports.ProductCategoryProduct = ProductCategoryProduct;
ProductCategoryProduct.metaDataForProductCategoryProduct = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.ProductCategoryProduct", ProductCategoryProduct);
//# sourceMappingURL=ProductCategoryProduct.js.map