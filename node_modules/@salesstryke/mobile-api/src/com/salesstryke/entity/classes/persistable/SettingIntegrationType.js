...
exports.SettingIntegrationType = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.SettingIntegrationType";
        this.mongDataModeName = "SettingIntegrationType";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class SettingIntegrationType extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.SettingIntegrationType";
        this.name = null;
    }
    /**
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.SettingIntegrationType");
    }
    /**
...
exports.SettingIntegrationType = SettingIntegrationType;
SettingIntegrationType.metaDataForSettingIntegrationType = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.SettingIntegrationType", SettingIntegrationType);
//# sourceMappingURL=SettingIntegrationType.js.map