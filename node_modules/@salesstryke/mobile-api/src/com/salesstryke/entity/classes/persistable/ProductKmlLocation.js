...
exports.ProductKmlLocation = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.ProductKmlLocation";
        this.mongDataModeName = "ProductKmlLocation";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class ProductKmlLocation extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.ProductKmlLocation";
        this.kml = null;
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.ProductKmlLocation");
    }
    /**
...
exports.ProductKmlLocation = ProductKmlLocation;
ProductKmlLocation.metaDataForProductKmlLocation = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.ProductKmlLocation", ProductKmlLocation);
//# sourceMappingURL=ProductKmlLocation.js.map