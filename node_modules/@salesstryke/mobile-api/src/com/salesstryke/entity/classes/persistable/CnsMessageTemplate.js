...
exports.CnsMessageTemplate = void 0;
...
class EntityAttributes {
    constructor() {
        ...
        this._channelTypeIsMutated = "_channelTypeIsMutated";
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.CnsMessageTemplate";
        this.mongDataModeName = "CnsMessageTemplate";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class CnsMessageTemplate extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        this._awsDataIsMutated = false;
        this._channelTypeIsMutated = false;
        ...
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.CnsMessageTemplate";
        this.name = null;
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.CnsMessageTemplate");
    }
    /**
     ...
     * @returns boolean
     */
    _getIsChannelTypeMutated() {
        return (this._channelTypeIsMutated);
    }
    /**
     *
     * @returns boolean
    ...
    /**
     * What channel type of message this template is for.
     * @returns string | null
     */
    getChannelType() {
...
* ```
     */
    _setIsChannelTypeMutated(_channelTypeIsMutated) {
        this._channelTypeIsMutated = _channelTypeIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    setAwsData(awsData) {
        if (!this._getIsMutateSuppressed() && this.awsData !== awsData) {
...
* ```
    ...
    setChannelType(channelType) {
        if (!this._getIsMutateSuppressed() && this.channelType !== channelType) {
            this._setIsChannelTypeMutated(true);
        }
        this.channelType = channelType;
        return (this);
    }
...
* ```
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.channelType);
...
exports.CnsMessageTemplate = CnsMessageTemplate;
CnsMessageTemplate.metaDataForCnsMessageTemplate = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.CnsMessageTemplate", CnsMessageTemplate);
//# sourceMappingURL=CnsMessageTemplate.js.map