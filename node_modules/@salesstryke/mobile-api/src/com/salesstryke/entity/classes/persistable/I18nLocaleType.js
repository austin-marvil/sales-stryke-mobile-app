...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.I18nLocaleType";
        this.mongDataModeName = "I18nLocaleType";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class I18nLocaleType extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.I18nLocaleType";
        this.name = null;
    }
    /**
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.I18nLocaleType");
    }
    /**
...
exports.I18nLocaleType = I18nLocaleType;
I18nLocaleType.metaDataForI18nLocaleType = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.I18nLocaleType", I18nLocaleType);
//# sourceMappingURL=I18nLocaleType.js.map