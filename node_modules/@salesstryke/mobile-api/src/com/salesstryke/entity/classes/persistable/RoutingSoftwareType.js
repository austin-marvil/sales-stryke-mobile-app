...
exports.RoutingSoftwareType = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.RoutingSoftwareType";
        this.mongDataModeName = "RoutingSoftwareType";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class RoutingSoftwareType extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.RoutingSoftwareType";
        this.name = null;
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.RoutingSoftwareType");
    }
    /**
    ...
    /**
     * The name of routing software type.
     * @returns string | null
     */
    getName() {
        return (this.name);
...
exports.RoutingSoftwareType = RoutingSoftwareType;
RoutingSoftwareType.metaDataForRoutingSoftwareType = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.RoutingSoftwareType", RoutingSoftwareType);
//# sourceMappingURL=RoutingSoftwareType.js.map