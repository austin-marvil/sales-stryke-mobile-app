...
exports.ProductPricingKmlLocation = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.ProductPricingKmlLocation";
        this.mongDataModeName = "ProductPricingKmlLocation";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class ProductPricingKmlLocation extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.ProductPricingKmlLocation";
        this.kml = null;
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.ProductPricingKmlLocation");
    }
    /**
...
exports.ProductPricingKmlLocation = ProductPricingKmlLocation;
ProductPricingKmlLocation.metaDataForProductPricingKmlLocation = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.ProductPricingKmlLocation", ProductPricingKmlLocation);
//# sourceMappingURL=ProductPricingKmlLocation.js.map