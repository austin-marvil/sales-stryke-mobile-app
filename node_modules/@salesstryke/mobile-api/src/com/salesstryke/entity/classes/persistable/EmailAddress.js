...
class EntityAttributes {
    constructor() {
        this._emailAddressIsMutated = "_emailAddressIsMutated";
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.EmailAddress";
        this.mongDataModeName = "EmailAddress";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class EmailAddress extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        this._emailAddressIsMutated = false;
        ...
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.EmailAddress";
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.EmailAddress");
    }
    /**
     ...
     * @returns boolean
     */
    _getIsEmailAddressMutated() {
        return (this._emailAddressIsMutated);
    }
    /**
...
* ```
     */
    _setIsEmailAddressMutated(_emailAddressIsMutated) {
        this._emailAddressIsMutated = _emailAddressIsMutated;
        return (this);
    }
    /**
...
* ```
    ...
    setEmailAddress(emailAddress) {
        if (!this._getIsMutateSuppressed() && this.emailAddress !== emailAddress) {
            this._setIsEmailAddressMutated(true);
        }
        this.emailAddress = emailAddress;
        return (this);
    }
...
* ```
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.emailAddress);
...
EmailAddress.metaDataForEmailAddress = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.EmailAddress", EmailAddress);
