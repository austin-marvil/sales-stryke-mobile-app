...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.OrganizationType";
        this.mongDataModeName = "OrganizationType";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class OrganizationType extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.OrganizationType";
        this.name = null;
    }
    /**
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.OrganizationType");
    }
    /**
...
OrganizationType.metaDataForOrganizationType = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.OrganizationType", OrganizationType);
