...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.I18nKeyType";
        this.mongDataModeName = "I18nKeyType";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class I18nKeyType extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.I18nKeyType";
        this.name = null;
    }
    /**
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.I18nKeyType");
    }
    /**
...
exports.I18nKeyType = I18nKeyType;
I18nKeyType.metaDataForI18nKeyType = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.I18nKeyType", I18nKeyType);
//# sourceMappingURL=I18nKeyType.js.map