...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.PermissionType";
        this.mongDataModeName = "PermissionType";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class PermissionType extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.PermissionType";
        this.name = null;
    }
    /**
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.PermissionType");
    }
    /**
    ...
    /**
     * The name of the PermissionType
     * @returns string | null
     */
    getName() {
        return (this.name);
...
PermissionType.metaDataForPermissionType = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.PermissionType", PermissionType);
