...
exports.CnsCampaignList = void 0;
...
class EntityAttributes {
    constructor() {
        ...
        this._expirationDateIsMutated = "_expirationDateIsMutated";
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.CnsCampaignList";
        this.mongDataModeName = "CnsCampaignList";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class CnsCampaignList extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        this._descriptionIsMutated = false;
        this._expirationDateIsMutated = false;
        ...
        this.jsonType = "com.salesstryke.entity.classes.persistable.CnsCampaignList";
        this.name = null;
    }
    /**
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.CnsCampaignList");
    }
    /**
     ...
     * @returns boolean
     */
    _getIsExpirationDateMutated() {
        return (this._expirationDateIsMutated);
    }
    /**
    ...
    /**
     * Boolean for camapign list if it is active.
     * @returns boolean
     */
    getIsActive() {
...
* ```
     */
    _setIsExpirationDateMutated(_expirationDateIsMutated) {
        this._expirationDateIsMutated = _expirationDateIsMutated;
        return (this);
    }
    /**
...
* ```
    ...
    setExpirationDate(expirationDate) {
        if (!this._getIsMutateSuppressed() && this.expirationDate !== expirationDate) {
            this._setIsExpirationDateMutated(true);
        }
        this.expirationDate = expirationDate;
        return (this);
    }
...
* ```
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.expirationDate);
...
exports.CnsCampaignList = CnsCampaignList;
CnsCampaignList.metaDataForCnsCampaignList = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.CnsCampaignList", CnsCampaignList);
//# sourceMappingURL=CnsCampaignList.js.map