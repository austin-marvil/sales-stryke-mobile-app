...
exports.ProductCategoryImage = void 0;
...
class EntityAttributes {
    constructor() {
        ...
        this._imagePathIsMutated = "_imagePathIsMutated";
        ...
        this._productCategoryIsMutated = "_productCategoryIsMutated";
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.ProductCategoryImage";
        this.mongDataModeName = "ProductCategoryImage";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class ProductCategoryImage extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this._imagePathIsMutated = false;
        ...
        this._productCategoryIsMutated = false;
        ...
        this.id = null;
        this.imagePath = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.ProductCategoryImage";
        this.name = null;
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.ProductCategoryImage");
    }
    /**
     ...
     * @returns boolean
     */
    _getIsImagePathMutated() {
        return (this._imagePathIsMutated);
    }
    /**
     ...
     * @returns boolean
     */
    _getIsProductCategoryMutated() {
        return (this._productCategoryIsMutated);
    }
    /**
     *
     * @returns boolean
...
* ```
     */
    _setIsImagePathMutated(_imagePathIsMutated) {
        this._imagePathIsMutated = _imagePathIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    _setIsProductCategoryMutated(_productCategoryIsMutated) {
        this._productCategoryIsMutated = _productCategoryIsMutated;
        return (this);
    }
    /**
...
* ```
    ...
    setImagePath(imagePath) {
        if (!this._getIsMutateSuppressed() && this.imagePath !== imagePath) {
            this._setIsImagePathMutated(true);
        }
        this.imagePath = imagePath;
        return (this);
    }
...
* ```
     */
    setProductCategory(productCategory, persistanceType) {
        if (!this._getIsMutateSuppressed() && this.productCategory !== productCategory) {
            PersistableUtils_1.PersistableUtils.mongoRefSetter(productCategory, persistanceType);
            this._setIsProductCategoryMutated(true);
        }
        this.productCategory = productCategory;
        return (this);
    }
...
* ```
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.imagePath);
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.productCategory);
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.workspace);
        return (hashCode_n);
    }
}
exports.ProductCategoryImage = ProductCategoryImage;
ProductCategoryImage.metaDataForProductCategoryImage = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.ProductCategoryImage", ProductCategoryImage);
//# sourceMappingURL=ProductCategoryImage.js.map