...
exports.ProductCategoryKmlLocation = void 0;
...
class EntityAttributes {
    constructor() {
        ...
        this._kmlGeometryIsMutated = "_kmlGeometryIsMutated";
        this._kmlIsMutated = "_kmlIsMutated";
        this._kmlLayerIsMutated = "_kmlLayerIsMutated";
        this._nameIsMutated = "_nameIsMutated";
        this._organizationIsMutated = "_organizationIsMutated";
        this._productCategoryProductIsMutated = "_productCategoryProductIsMutated";
        ...
        this.kml = "kml";
        this.kmlGeometry = "kmlGeometry";
        this.kmlLayer = "kmlLayer";
        this.modifiedDate = "modifiedDate";
        this.name = "name";
        this.organization = "organization";
        this.productCategoryProduct = "productCategoryProduct";
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.ProductCategoryKmlLocation";
        this.mongDataModeName = "ProductCategoryKmlLocation";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class ProductCategoryKmlLocation extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this._kmlGeometryIsMutated = false;
        this._kmlIsMutated = false;
        this._kmlLayerIsMutated = false;
        this._nameIsMutated = false;
        this._organizationIsMutated = false;
        this._productCategoryProductIsMutated = false;
        this._workspaceIsMutated = false;
        this.description = null;
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.ProductCategoryKmlLocation";
        this.kml = null;
        this.kmlGeometry = null;
        this.kmlLayer = null;
        this.name = null;
        this.organization = null;
        this.productCategoryProduct = null;
        this.workspace = null;
    }
    /**
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.ProductCategoryKmlLocation");
    }
    /**
     ...
     * @returns boolean
     */
    _getIsKmlGeometryMutated() {
        return (this._kmlGeometryIsMutated);
    }
    /**
     *
     * @returns boolean
     */
    _getIsKmlMutated() {
        return (this._kmlIsMutated);
    }
    /**
     *
     * @returns boolean
     */
    _getIsKmlLayerMutated() {
        return (this._kmlLayerIsMutated);
    }
    /**
     *
     * @returns boolean
     ...
     * @returns boolean
     */
    _getIsProductCategoryProductMutated() {
        return (this._productCategoryProductIsMutated);
    }
    /**
     *
     * @returns boolean
...
* ```
     */
    _setIsKmlGeometryMutated(_kmlGeometryIsMutated) {
        this._kmlGeometryIsMutated = _kmlGeometryIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    _setIsKmlMutated(_kmlIsMutated) {
        this._kmlIsMutated = _kmlIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    _setIsKmlLayerMutated(_kmlLayerIsMutated) {
        this._kmlLayerIsMutated = _kmlLayerIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    _setIsProductCategoryProductMutated(_productCategoryProductIsMutated) {
        this._productCategoryProductIsMutated = _productCategoryProductIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    setKml(kml, persistanceType) {
        if (!this._getIsMutateSuppressed() && this.kml !== kml) {
            PersistableUtils_1.PersistableUtils.mongoRefSetter(kml, persistanceType);
            this._setIsKmlMutated(true);
        }
        this.kml = kml;
        return (this);
    }
...
* ```
     */
    setKmlGeometry(kmlGeometry, persistanceType) {
        if (!this._getIsMutateSuppressed() && this.kmlGeometry !== kmlGeometry) {
            PersistableUtils_1.PersistableUtils.mongoRefSetter(kmlGeometry, persistanceType);
            this._setIsKmlGeometryMutated(true);
        }
        this.kmlGeometry = kmlGeometry;
        return (this);
    }
...
* ```
     */
    setKmlLayer(kmlLayer, persistanceType) {
        if (!this._getIsMutateSuppressed() && this.kmlLayer !== kmlLayer) {
            PersistableUtils_1.PersistableUtils.mongoRefSetter(kmlLayer, persistanceType);
            this._setIsKmlLayerMutated(true);
        }
        this.kmlLayer = kmlLayer;
        return (this);
    }
...
* ```
     */
    setProductCategoryProduct(productCategoryProduct, persistanceType) {
        if (!this._getIsMutateSuppressed() && this.productCategoryProduct !== productCategoryProduct) {
            PersistableUtils_1.PersistableUtils.mongoRefSetter(productCategoryProduct, persistanceType);
            this._setIsProductCategoryProductMutated(true);
        }
        this.productCategoryProduct = productCategoryProduct;
        return (this);
    }
...
* ```
    ...
    _getIsMutated() {
        ...
        this._setCurrentState2({
            attributeName: 'productCategoryProduct',
            value: this.productCategoryProduct
        });
        this._setCurrentState2({
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.kml);
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.kmlGeometry);
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.kmlLayer);
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.productCategoryProduct);
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.workspace);
        return (hashCode_n);
    }
}
exports.ProductCategoryKmlLocation = ProductCategoryKmlLocation;
ProductCategoryKmlLocation.metaDataForProductCategoryKmlLocation = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.ProductCategoryKmlLocation", ProductCategoryKmlLocation);
//# sourceMappingURL=ProductCategoryKmlLocation.js.map