...
exports.SettingWorkspaceCAL = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.SettingWorkspaceCAL";
        this.mongDataModeName = "SettingWorkspaceCAL";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class SettingWorkspaceCAL extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.jsonType = "com.salesstryke.entity.classes.persistable.SettingWorkspaceCAL";
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.SettingWorkspaceCAL");
    }
    /**
...
exports.SettingWorkspaceCAL = SettingWorkspaceCAL;
SettingWorkspaceCAL.metaDataForSettingWorkspaceCAL = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.SettingWorkspaceCAL", SettingWorkspaceCAL);
//# sourceMappingURL=SettingWorkspaceCAL.js.map