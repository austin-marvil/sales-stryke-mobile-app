...
exports.CnsEndPointSignupStatusType = void 0;
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.CnsEndPointSignupStatusType";
        this.mongDataModeName = "CnsEndPointSignupStatusType";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class CnsEndPointSignupStatusType extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.jsonType = "com.salesstryke.entity.classes.persistable.CnsEndPointSignupStatusType";
        this.name = null;
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.CnsEndPointSignupStatusType");
    }
    /**
    ...
    /**
     * The name description of the signup status type.
     * @returns string | null
     */
    getDescription() {
    ...
    /**
     * Indicates if the signup status type is active or not.
     * @returns boolean
     */
    getIsActive() {
    ...
    /**
     * The name of the signup status type: OPT_IN, OPT_OUT, PENDING.
     * @returns string | null
     */
    getName() {
        return (this.name);
...
exports.CnsEndPointSignupStatusType = CnsEndPointSignupStatusType;
CnsEndPointSignupStatusType.metaDataForCnsEndPointSignupStatusType = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.CnsEndPointSignupStatusType", CnsEndPointSignupStatusType);
//# sourceMappingURL=CnsEndPointSignupStatusType.js.map