...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.AgreementType";
        this.mongDataModeName = "AgreementType";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class AgreementType extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        ...
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.AgreementType";
        this.name = null;
    }
    /**
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.AgreementType");
    }
    /**
    ...
    /**
     * The description of the agreement type.
     * @returns string | null
     */
    getDescription() {
...
AgreementType.metaDataForAgreementType = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.AgreementType", AgreementType);
