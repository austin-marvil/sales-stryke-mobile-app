...
class EntityAttributes {
    constructor() {
        ...
        this._i18nTextsIsMutated = "_i18nTextsIsMutated";
...
class MetaData {
    constructor() {
        this.namespace = "com.salesstryke.entity.classes.persistable.I18nCategory";
        this.mongDataModeName = "I18nCategory";
        this.entityAttributes = new EntityAttributes();
        this.mongoAttributes = new MongoAttributes();
    }
}
class I18nCategory extends JsonApiPersistableBase_1.JsonApiPersistableBase {
    constructor(p) {
        super(p);
        this._descriptionIsMutated = false;
        this._i18nTextsIsMutated = false;
        ...
        this.i18nTexts = new Array();
        this.id = null;
        this.jsonType = "com.salesstryke.entity.classes.persistable.I18nCategory";
        this.name = null;
    }
    /**
    ...
    getClassName() {
        return ("com.salesstryke.entity.classes.persistable.I18nCategory");
    }
    /**
     * The i18nText items that are in the given category.
     *
     * Default PersistenceType : PersistenceType.ATTACH
     */
    addI18nText(i18nText, persistanceType = PersistenceType_1.PersistenceType.ATTACH) {
        if (this._getIsTrackingMutations()) {
            i18nText._trackMutations();
        }
        i18nText._setRelationshipPersistableType(persistanceType.getId());
        this.i18nTexts.push(i18nText);
        return (this);
    }
    /**
     * The i18nText items that are in the given category.
     ...
     */
    removeI18nText(i18nText, persistanceType = PersistenceType_1.PersistenceType.DETACH) {
        if (this._getIsTrackingMutations()) {
            i18nText._trackMutations();
        }
        if (persistanceType === PersistenceType_1.PersistenceType.NONE) {
            let index = this.i18nTexts.findIndex(obj => obj === i18nText);
            if (index !== -1) {
                this.i18nTexts.splice(index, 1);
            }
            i18nText._setRelationshipPersistableType(PersistenceType_1.PersistenceType.NONE.getId());
            return (this);
        }
        i18nText._setRelationshipPersistableType(persistanceType.getId());
        this.i18nTexts.push(i18nText);
     ...
     * @returns boolean
     */
    _getIsI18nTextsMutated() {
        return (this._i18nTextsIsMutated);
    }
    /**
    ...
    /**
     * The description of the category. Example: Basic UI controls.
     * @returns string | null
     */
    getDescription() {
...
* ```
     */
    _setIsI18nTextsMutated(_i18nTextsIsMutated) {
        this._i18nTextsIsMutated = _i18nTextsIsMutated;
        return (this);
    }
    /**
...
* ```
     */
    setI18nTexts(i18nTexts) {
        if (!this._getIsMutateSuppressed() && this.i18nTexts !== i18nTexts) {
            this._setIsI18nTextsMutated(true);
        }
        this.i18nTexts = i18nTexts;
        return (this);
    }
...
* ```
    ...
    _getIsMutated() {
        ...
        this._setCurrentState2({
            attributeName: 'i18nTexts',
            value: this.i18nTexts
        });
        this._setCurrentState2({
            attributeName: 'id',
            value: this.id
    ...
    getHashCode() {
        ...
        hashCode_n += HashCodeUtil_1.HashCodeUtil.getHashCodeFromValue(this.i18nTexts);
...
exports.I18nCategory = I18nCategory;
I18nCategory.metaDataForI18nCategory = new MetaData();
ClassFor_1.ClassFor.getInstance().addClass("com.salesstryke.entity.classes.persistable.I18nCategory", I18nCategory);
//# sourceMappingURL=I18nCategory.js.map